...
<div class="clear"> </div>
			...
			<div class="wrap">
				...
				<div class="outer-w3-agile mt-3">
					...
					<form action="" class="paymentForm" id="form" method="post" >
							...
							<div class="form-group col-md-6">
								...
								<select id="amount" class="form-control" name="amount" >
									...
									<div class="form-group col-md-6">
											...
											<input name="housemate" id="housemate" type="text" class="form-control" id="inputCity" required="">
									</div>
									<div class="form-group col-md-6">
										...
										<br><br>
										<button   type="submit"  name="vote"  class="btn btn-primary btn-block"><h4>VOTE</h4></button>
								</div>
...
$.ajax({
    ...
    // TODO: The rest of the code will go here...
            ...
            <script>
    var paymentForm = document.getElementByClassName('paymentForm');
